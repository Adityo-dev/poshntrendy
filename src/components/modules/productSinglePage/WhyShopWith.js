...
function WhyShopWith() {
  return (
    <section className="container mx-auto rounded-[12px] bg-[#400A38] text-[#FBF9FB] py-6 px-8 grid grid-cols-12">
      ...
      <div className="col-span-3 space-y-2 border-s border-[#605F5F] ps-8">
        <p>Do you need help with customisation or shipping of this product?</p>
